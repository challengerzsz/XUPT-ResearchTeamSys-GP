  ...
  <div class="paperDiv">
    ...
    <span>
      <el-row class="buttonRow">
        <el-button type="primary" @click="uploadPaper()">上传报销明细</el-button>
      </el-row>
    </span>
    <span class="dividerSpan">
    ...
    <div>
      <el-table :data="tableData" style="width: 100%">
        <el-table-column label="报销人学号" width="135">
        ...
        <el-table-column label="报销人姓名" width="135">
          <template slot-scope="scope">
            <div slot="reference" class="name-wrapper">
              <el-tag size="medium">
        ...
        <el-table-column label="报销类型" width="135">
          <template slot-scope="scope">
            <div slot="reference" class="name-wrapper">
        ...
        <el-table-column label="总价" width="135">
          <template slot-scope="scope">
        ...
        <el-form ref="form" :model="form" label-width="100px">
          <el-form-item label="报销类型">
            ...
            <el-select style="width:100%" v-model="form.type" placeholder="请选择">
              <el-option
                v-for="item in claimExpenseTypeOptions"
                :key="item.value"
                :label="item.value"
                :value="item.value"
              ></el-option>
          ...
          <el-form-item label="单价">
            <el-input type="text" v-model="form.unitPrice"></el-input>
          </el-form-item>
          <el-form-item label="数量">
            <el-input type="text" v-model="form.amount"></el-input>
          </el-form-item>
          <el-form-item label="总价">
            <el-input disabled type="text" v-model="form.totalPrice"></el-input>
          </el-form-item>
          <el-form-item label="备注">
            <el-input type="textarea" @focus="totalPriceCompute()" v-model="form.comment"></el-input>
          </el-form-item>
    ...
    >
      <el-form :model="form">
        <el-form-item label="报销人学号" :label-width="formLabelWidth">
          <el-input disabled v-model="updateform.userAccount" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="报销人姓名" :label-width="formLabelWidth">
        ...
        <el-form-item label="单价" :label-width="formLabelWidth">
          <el-input v-model="updateform.unitPrice" autocomplete="off"></el-input>
        </el-form-item>
        ...
        <el-form-item label="总价" :label-width="formLabelWidth">
          <el-input v-model="updateform.totalPrice" autocomplete="off"></el-input>
        </el-form-item>
        ...
        <el-form-item label="时间" :label-width="formLabelWidth">
          <el-input v-model="updateform.date" autocomplete="off"></el-input>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(index, row) {
      ...
      this.$axios
        .post("/api/dailyWork/claimExpense/deleteClaimExpense/"+this.updateform.id)
        .then(response => {
          console.log(response.data);
          this.reload();
        })
