<template>
  <div class="userInfoMain">
    <div>
      <div class="userImg">
        <el-avatar :size="150" :src="form.avatar"></el-avatar>
      </div>
      <div class="userInfo">
        <el-form ref="form" :model="form" label-width="150px">
          ...
          <el-form-item label="性别">
            <el-radio v-model="form.male" label="0">男</el-radio>
            <el-radio v-model="form.male" label="1">女</el-radio>
          </el-form-item>
          <el-form-item label="学历">
            <el-select style="width:100%;" size="medium" v-model="form.education" placeholder="请选择">
              <el-option
